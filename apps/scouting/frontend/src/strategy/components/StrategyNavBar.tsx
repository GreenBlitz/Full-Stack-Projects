...
const options: NavOption[] = [
  { to: "team", label: "Team", icon: AiOutlineTeam },
  { to: "general", label: "General", icon: LuTable },
  { to: "compare", label: "Compare", icon: LuSwords },
  { to: "forecast", label: "Forecast", icon: TiWeatherCloudy },
];

export const StrategyNavBar: FC = () => {
  return (
...
const NavElement: FC<NavElementProps> = ({ isActive, Icon, label }) => (
  <>
